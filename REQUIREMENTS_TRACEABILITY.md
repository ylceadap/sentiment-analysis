...
| At least one unit test for a class, preferably model class | Required | Model fit/predict, explanation, probability, deterministic and save/load tests | 43 passing tests; 76% total branch coverage | Complete |
...
| Keep experiment logic reviewable | Shared `experiment_data`, `experiment_utils`, `embedding_runtime`, and `ordinal` modules | Complete |
